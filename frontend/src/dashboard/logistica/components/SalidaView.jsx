...
export default function SalidaView({ data: movimientos = [], isFetching, onRefresh, onFilterChange }) {
  ...
  const handleReport = (filters) => {
    ...
    window.open(`${API_URL}/cotizaciones/reportes/reporte_almacen_salidas_dashboard_html/?${query}`, "_blank");
  };
  ...
  return (
    <div className="flex flex-col h-full p-6">
      ...
      <NuevaLogisticaModal open={openNueva} onClose={() => { setOpenNueva(false); onRefresh(); }} operacion="S" />
